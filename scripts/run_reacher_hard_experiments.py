"""
Phase 2: Reacher-hard DMControl Experiment
==========================================

Runs ALL 5 approaches on the Reacher-hard environment with 5 seeds each
(25 total runs).
...
OBS_DIM = 6  # Reacher-hard: position(2) + to_target(2) + velocity(2)
...
def collect_episodes(
    domain: str, task: str, num_episodes: int, seed: int
) -> List[Dict]:
...
def main():
    print("=" * 70)
    print("PHASE 2: REACHER-HARD - ALL 5 APPROACHES x 5 SEEDS")
    print("=" * 70)
    print(f"Device: {DEVICE}")
    ...
    print(
        ...
        f"stoch={STOCH_DIM}, deter={DETER_DIM}"
    )
    print()
    ...
    # -----------------------------------------------------------------------
    print("\n" + "=" * 70)
    print("AGGREGATED RESULTS - REACHER-HARD")
    print("=" * 70)
