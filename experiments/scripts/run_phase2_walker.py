"""
Phase 2: Walker-walk DMControl Experiment
==========================================

Runs ALL 5 approaches on the Walker-walk environment with 5 seeds each.
...
OBS_DIM = 24  # Walker-walk: orientations(14) + height(1) + velocity(9)
ACTION_DIM = 6  # Continuous [-1, 1]
STOCH_DIM = 64
DETER_DIM = 512
HIDDEN_DIM = 512
...
def run_single(approach: str, seed: int, train_episodes: List[Dict]) -> Dict:
    ...
    test_episodes = collect_episodes("walker", "walk", 50, seed + 10000)
...
def main():
    print("=" * 70)
    print("PHASE 2: WALKER-WALK - ALL 5 APPROACHES x 5 SEEDS")
    print("=" * 70)
    print(f"Device: {DEVICE}")
    ...
    results_dir = PROJECT_ROOT / "experiments" / "results" / "phase2" / "walker"
    ...
    for approach in APPROACHES:
        ...
        for seed in EXPERIMENT_SEEDS:
            ...
            train_episodes = collect_episodes("walker", "walk", NUM_EPISODES, seed)
    ...
    # -----------------------------------------------------------------------
    print("\n" + "=" * 70)
    print("AGGREGATED RESULTS - WALKER-WALK")
    print("=" * 70)
    ...
    complete_metrics = {
        ...
        "environment": {"domain": "walker", "task": "walk", "obs_dim": OBS_DIM, "action_dim": ACTION_DIM},
        "config": {
            "stoch_dim": STOCH_DIM,
            "deter_dim": DETER_DIM,
            "hidden_dim": HIDDEN_DIM,
