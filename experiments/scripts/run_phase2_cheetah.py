"""
Phase 2: Cheetah-run DMControl Experiment
==========================================

Runs ALL 5 approaches on the Cheetah-run environment with 5 seeds each.
...
OBS_DIM = 17  # Cheetah-run: position(8) + velocity(9)
...
def run_single(approach: str, seed: int, train_episodes: List[Dict]) -> Dict:
    ...
    test_episodes = collect_episodes("cheetah", "run", 50, seed + 10000)
...
def main():
    print("=" * 70)
    print("PHASE 2: CHEETAH-RUN - ALL 5 APPROACHES x 5 SEEDS")
    print("=" * 70)
    print(f"Device: {DEVICE}")
    ...
    results_dir = PROJECT_ROOT / "experiments" / "results" / "phase2" / "cheetah"
    ...
    for approach in APPROACHES:
        ...
        for seed in EXPERIMENT_SEEDS:
            ...
            train_episodes = collect_episodes("cheetah", "run", NUM_EPISODES, seed)
    ...
    # -----------------------------------------------------------------------
    print("\n" + "=" * 70)
    print("AGGREGATED RESULTS - CHEETAH-RUN")
    print("=" * 70)
    ...
    complete_metrics = {
        ...
        "environment": {"domain": "cheetah", "task": "run", "obs_dim": OBS_DIM, "action_dim": ACTION_DIM},
        "config": {
            "stoch_dim": STOCH_DIM,
            "deter_dim": DETER_DIM,
            "hidden_dim": HIDDEN_DIM,
